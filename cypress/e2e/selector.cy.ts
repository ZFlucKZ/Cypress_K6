describe('Selectors', () => {
  ...
  it('selects elements correctly', () => {
    ...
    cy.get('#title').parent().parent().find('img').should('have.attr', 'src', '/_ipx/_/cy/01.jpg')

    cy.get('#title').parent().parent().find('button').should('contain', 'Explore')
  })
  ...
  it('selects elements by using dataCy correctly', () => {
  ...
  it.only('verified data in table correctly', () => {
    const people = [
      {
        id: 1,
        name: 'Lindsay Walton',
